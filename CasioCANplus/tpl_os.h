...
DeclareTask(Hearbeat_PeriodicTask);
DeclareTask(Serial_PeriodicTask);
DeclareAlarm(HeatbeatAlarm);
DeclareAlarm(SerialAlarm);
DeclareMessage(serialMsgReceive);
DeclareMessage(serialMsgSend);
