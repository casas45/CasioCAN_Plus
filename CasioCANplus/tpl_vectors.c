...
extern FUNC(void, OS_CODE) tpl_primary_irq_handler_TIM16_FDCAN_IT0_IRQ(void);
...
extern FUNC(void, OS_CODE) TIM16_FDCAN_IT0_IRQHandler(void);
...
__attribute__ ((section(".isr_vector"))) CONST(tpl_it_handler, OS_CONST) tpl_it_vectors[48] = {
  ...
  (tpl_it_handler)tpl_null_it,
  (tpl_it_handler)tpl_null_it,
  (tpl_it_handler) tpl_primary_irq_handler_TIM16_FDCAN_IT0_IRQ,
  (tpl_it_handler)tpl_null_it,
  (tpl_it_handler)tpl_null_it,
  (tpl_it_handler)tpl_null_it,
  (tpl_it_handler)tpl_null_it,
