...
filename = '../../../../../machines/cortex-m/armv6m/stm32g0b1/CMSIS/Device/ST/STM32G0xx/Include/stm32g0b1xx.h'
...
startExtractRegExp=re.compile('.*STM32G0xxxx specific Interrupt Numbers.*$')
...
with open("interruptDefs.oil",'w') as outFile:
    ...
    for IRQName,IRQn,IRQdesc in interruptList:
        ...
        outFile.write('    NAME = "'+IRQName+'Handler";\n')
        outFile.write('  };\n')
