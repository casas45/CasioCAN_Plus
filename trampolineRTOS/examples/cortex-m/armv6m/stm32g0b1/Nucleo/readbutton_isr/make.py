...
# -*- coding: UTF-8 -*-
#----------------------------------------------------------------------
#--- Python Make file for application readbutton_isr
...
try:
	...
	print("\033[91mThe OS->BUILD->TRAMPOLINE_BASE_PATH key is not set correctly in the oil file readbutton_isr.oil.")
	print("Set the correct Trampoline installation path in the oil file and run goil again:\033[0m")
	print("goil -t=cortex-m/armv6m/stm32g0b1 --templates=../../../../../../goil/templates/ readbutton_isr.oil")
	sys.exit(1)
...
#----------------------------------------------------------------------
oilFile = "readbutton_isr.oil"
oilFileDep = "build/" + oilFile + ".dep"
oilCompiler = "goil"
oilFlags = ["-t=cortex-m/armv6m/stm32g0b1", "--templates=../../../../../../goil/templates/"]
...
#--- Add generated files
sourceList.append("readbutton_isr/tpl_app_config.c")

sourceList.append("readbutton_isr/tpl_dispatch_table.c")
sourceList.append("readbutton_isr/tpl_invoque.S")
sourceList.append("readbutton_isr/tpl_primary_irq.S")
sourceList.append("readbutton_isr/tpl_vectors.c")
sourceList.append("readbutton_isr/tpl_external_interrupts.c")
sourceList.append("readbutton_isr/tpl_app_interrupts.c")
