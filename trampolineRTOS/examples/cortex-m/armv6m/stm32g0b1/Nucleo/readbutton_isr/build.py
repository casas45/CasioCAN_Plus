...
# -*- coding: UTF-8 -*-
#----------------------------------------------------------------------
#--- Python Build file for application readbutton_isr
...
cflags += "-DSTM32G0B1xx".split()
cppflags += "-DSTM32G0B1xx".split()
cflags += "-g".split()
cppflags += "-g".split()
cflags += "-Wall".split()
cppflags += "-Wall".split()
...
cflags += "-mcpu=cortex-m0plus".split()
cppflags += "-mcpu=cortex-m0plus".split()
cflags += "-mthumb".split()
...
includeDirs += ["-I","../../../../../../machines/cortex-m/armv6m"]
includeDirs += ["-I","../../../../../../machines/cortex-m/CMSIS/Include"]
includeDirs += ["-I","../../../../../../machines/cortex-m/armv6m/stm32g0b1"]
includeDirs += ["-I","../../../../../../machines/cortex-m/armv6m/stm32g0b1/lib"]
includeDirs += ["-I","../../../../../../machines/cortex-m/armv6m/stm32g0b1/STM32G0xx_HAL_Driver/Inc"]
includeDirs += ["-I","../../../../../../machines/cortex-m/armv6m/stm32g0b1/STM32G0xx_HAL_Driver/Src"]
includeDirs += ["-I","../../../../../../machines/cortex-m/armv6m/stm32g0b1/CMSIS/Device/ST/STM32G0xx/Include"]
includeDirs += ["-I","../../../../../../machines/cortex-m/armv6m/stm32g0b1"]
if with_ioc:
  includeDirs += ["-I", "../../../../../../ioc"]
includeDirs += ["-I", "../../../../../../com"]
...
ldflags += "-Map=readbutton_isr.map".split()
ldflags += ["-L", "readbutton_isr"]
ldflags += ["-T", "script.ld"]
asflags += "-g".split()
asflags += "-Wall".split()
asflags += "-mcpu=cortex-m0plus".split()
...
#--- OIL file
oilSourceList.append("readbutton_isr.oil")
...
cSourceList.append(projfile.ProjectFile("readbutton_isr.c"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("readbutton_isr/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("readbutton_isr/tpl_dispatch_table.c"))
cSourceList.append(projfile.ProjectFile("readbutton_isr/tpl_invoque.S"))
cSourceList.append(projfile.ProjectFile("readbutton_isr/tpl_primary_irq.S"))
cSourceList.append(projfile.ProjectFile("readbutton_isr/tpl_vectors.c"))
cSourceList.append(projfile.ProjectFile("readbutton_isr/tpl_external_interrupts.c"))
cSourceList.append(projfile.ProjectFile("readbutton_isr/tpl_app_interrupts.c"))
...
cSourceList.append(projfile.ProjectFile("machines/cortex-m/armv6m/sys_handlers.c", trampoline_base_path))
cSourceList.append(projfile.ProjectFile("machines/cortex-m/armv6m/tpl_ctx_switch.S", trampoline_base_path))
cSourceList.append(projfile.ProjectFile("machines/cortex-m/armv6m/tpl_ctx_switch_under_it.S", trampoline_base_path))
cSourceList.append(projfile.ProjectFile("machines/cortex-m/armv6m/tpl_interrupts.S", trampoline_base_path))
cSourceList.append(projfile.ProjectFile("machines/cortex-m/armv6m/stm32g0b1/startup_stm32g0b1.c", trampoline_base_path))
cSourceList.append(projfile.ProjectFile("machines/cortex-m/armv6m/stm32g0b1/system_stm32g0xx.c", trampoline_base_path))
cSourceList.append(projfile.ProjectFile("machines/cortex-m/armv6m/stm32g0b1/tpl_machine_stm32g0b1.c", trampoline_base_path))
cSourceList.append(projfile.ProjectFile("machines/cortex-m/armv6m/stm32g0b1/lib/pinAccess.c", trampoline_base_path))
cSourceList.append(projfile.ProjectFile("machines/cortex-m/armv6m/stm32g0b1/STM32G0xx_HAL_Driver/Src/stm32g0xx_hal_gpio.c", trampoline_base_path))
cSourceList.append(projfile.ProjectFile("machines/cortex-m/armv6m/stm32g0b1/tpl_trace.c", trampoline_base_path))
#----------------------------------------------------------------------
...
if True:
  postCommand = makefile.PostCommand("Generating binary readbutton_isr_exe.hex from readbutton_isr_exe")
  postCommand.mCommand.append(r"arm-none-eabi-objcopy")
  postCommand.mCommand += "-Oihex".split()
  postCommand.mCommand.append("readbutton_isr_exe")
  postCommand.mCommand.append("readbutton_isr_exe.hex")
...
postVariableMapping = dict(
  ...
  BOARD_PATH='../../../../../../machines/cortex-m/armv6m/stm32g0b1',
  TARGET='cortex-m/armv6m/stm32g0b1'
)
...
if make.errorCount() == 0:
  if askedGoal == "burn" :
    ...
    commandLine += "readbutton_isr_exe.bin "
    ...
    if makefile.find_executable("st-flash") != None:
      print("\033[1m\033[95mFlashing readbutton_isr_exe on cortex-m/armv6m/stm32g0b1\033[0m")
